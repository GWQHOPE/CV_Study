...
# 线性分类器的基类，定义了分类器的训练和预测方法
  ...
  def train(self, X, y, learning_rate=1e-3, reg=1e-5, num_iters=100,
    ...
    num_classes = np.max(y) + 1  # 假设 y 的值为 0...K-1，其中 K 为类别数
    if self.W is None:
      # 懒惰地初始化 W
...
# 继承自 LinearClassifier，实现了 SVM 的损失计算
  """ 一个使用多类 SVM 损失函数的子类 """
